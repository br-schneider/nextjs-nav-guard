...
**Unreleased:** The navigation concurrency fixes and `NavigationGuardLink` documented here are available in the repository but are not included in npm version `1.0.9`. See the [changelog](https://github.com/br-schneider/nextjs-nav-guard/blob/main/CHANGELOG) for release status.
