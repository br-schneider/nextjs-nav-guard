...
function NavigationGuardProvider({ children, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(NavigationGuardProviderContext_1.NavigationGuardProviderContext.Provider, { value: guardMapRef, children: (0, jsx_runtime_1.jsx)(InterceptAppRouterProvider_1.InterceptAppRouterProvider, { guardMapRef: guardMapRef, children: (0, jsx_runtime_1.jsx)(InterceptPagesRouterProvider_1.InterceptPagesRouterProvider, { guardMapRef: guardMapRef, children: children }) }) }));
}
