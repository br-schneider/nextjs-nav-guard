...
export type NavigationGuardLinkProps = Omit<
  ComponentPropsWithoutRef<typeof Link>,
  "legacyBehavior" | "onNavigate"
> & {
  onNavigate?: (event: { preventDefault(): void }) => void;
};

export const NavigationGuardLink = forwardRef<
  HTMLAnchorElement,
  NavigationGuardLinkProps
>(function NavigationGuardLink(
  { onClick, onNavigate, replace, scroll, ...props },
  ref,
) {
  ...
  return (
    <Link
      ...
      onClick={(event) => {
        ...
        if (!guards || !router || !hasEnabledGuards(guards.current, params))
          return;
